                            ...
                            return (
                                <View key={index} style={[styles.photoView, { borderRadius: this.props.borderRadius }]}>
                                    <TouchableOpacity onPress={() => { this.photoPopupToggle(item.url) }}>
                                        <Image source={{ uri: item.link }} style={[styles.ImageStyle, { borderRadius: this.props.borderRadius }]} />
                                    </TouchableOpacity>
                                </View>
                            )
                        }
                ...
                <View key={row[0].url} style={styles.alignCenter}>
                    <View key={row[0].url} style={[styles.expandedView, { borderRadius: this.props.borderRadius }]}>
                        <TouchableOpacity onPress={() => { this.photoPopupToggle(row[0].url) }}>
                            <Image source={{ uri: row[0].link }} style={[styles.ImageStyle, styles.expandedImage, { borderRadius: this.props.borderRadius }]} />
                        </TouchableOpacity>
                    </View>
                </View>
            )
                    ...
                    <View key={row[1].url} style={styles.flexCol}>
                        <View style={[styles.photoView, { borderRadius: this.props.borderRadius }]}>
                            <TouchableOpacity onPress={() => { this.photoPopupToggle(row[1].url) }}>
                                <Image source={{ uri: row[1].link }} style={[styles.ImageStyle, { borderRadius: this.props.borderRadius }]} />
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
                    ...
                    <View key={row[1].url} style={styles.flexCol}>
                        ...
                        <View style={[styles.photoView, { borderRadius: this.props.borderRadius }]}>
                            <TouchableOpacity onPress={() => { this.photoPopupToggle(row[2].url) }}>
                                <Image source={{ uri: row[2].link }} style={[styles.ImageStyle, { borderRadius: this.props.borderRadius }]} />
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
            ...
            return (
                <View key={row[0].url} style={styles.alignCenter}>
                    <View key={row[0].url} style={styles.flexCol}>
                        <View style={[styles.photoView, { borderRadius: this.props.borderRadius }]}>
                            <TouchableOpacity onPress={() => { this.photoPopupToggle(row[0].url) }}>
                                <Image source={{ uri: row[0].link }} style={[styles.ImageStyle, { borderRadius: this.props.borderRadius }]} />
                            </TouchableOpacity>
                        </View>
            ...
            return (
                <View key={row[0].url} style={styles.alignCenter}>
                    ...
                    <View style={[styles.expandedView, { borderRadius: this.props.borderRadius }]}>
                        <TouchableOpacity onPress={() => { this.photoPopupToggle(row[2].url) }}>
                            <Image source={{ uri: row[2].link }} style={[styles.ImageStyle, styles.expandedImage, { borderRadius: this.props.borderRadius }]} />
                        </TouchableOpacity>
                    </View>
                </View>
            )
