...
export class ResultSwiperScreen extends Component {
    ...
    setTypeData() {
        this.state.data = this.props.root.data_search;
    ...
    checkPosition() {
        for( var i in this.state.data ) {
            if (this.state.data[i].id == this.props.root.selected_search.id) {
...
export default connect(mapStateToProps)(ResultSwiperScreen)
